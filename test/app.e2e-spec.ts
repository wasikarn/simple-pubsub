...
import { eventGenerator, randomMachine } from '../src/commons/helpers';
import { MachineRefillEvent } from '../src/modules/machine/events/machine-refill-event';
import { MachineSaleEvent } from '../src/modules/machine/events/machine-sale-event';
import { PublishSubscribeService } from '../src/modules/machine/services/publish-subscribe.service';

jest.mock('../src/commons/helpers', () => ({
